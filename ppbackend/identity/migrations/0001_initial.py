    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.CharField(default='qRvxTsl-UFw2Vv0_-bPuC', editable=False, max_length=21, primary_key=True, serialize=False, verbose_name='id')),
                ('avatar', models.ImageField(blank=True, upload_to='ar/users/avatar/%Y/%m/%d/')),
